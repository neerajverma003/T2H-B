              ...
              <td align="center">
                <div style="width: 100%; max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 20px; overflow: hidden; box-shadow: 0 20px 40px rgba(0, 0, 0, 0.08); text-align: left; box-sizing: border-box;">
                  ...
                  <div style="padding: 40px 30px; box-sizing: border-box;">
                    ...
                    <!-- CTA Button -->
                    <div style="text-align: center; margin: 50px 0 30px;">
                      <a href="${frontendUrl}/my-bookings" style="display: inline-block; background-color: #0F3AB2; color: #ffffff; font-size: 14px; font-weight: 800; text-transform: uppercase; letter-spacing: 2px; padding: 20px 45px; text-decoration: none; border-radius: 50px; box-shadow: 0 10px 30px rgba(15, 58, 178, 0.3);">
                        View Full Itinerary
                      </a>
                    </div>
